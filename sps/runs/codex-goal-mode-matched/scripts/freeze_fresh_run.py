...
def main() -> None:
    ...
    epoch = int(time.time())
    invocation = json.loads((ROOT / "invocation_manifest.json").read_text(encoding="utf-8"))
    start_epoch = int(invocation["start_epoch"])
    ...
    payload = {
        ...
        "elapsed_to_freeze_seconds": epoch - start_epoch,
